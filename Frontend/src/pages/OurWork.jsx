      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <section className="text-center mb-12">
          ...
          <p className="max-w-3xl mx-auto text-gray-600 px-2" style={{ fontFamily: "Montserrat", fontWeight: 400 }}>
            Every project we take on starts with one question: what will make this brand stand out?
            From strategy and design to production and execution, our work is built to create real impact, not just good-looking content.
            We collaborate closely with brands across industries to shape ideas, tell stories, and bring campaigns to life—online and on ground. Whether it’s building a visual identity, producing content, running performance campaigns, or executing activations, our focus stays the same: clarity, creativity, and results.
            What you’ll see here isn’t just work we’ve done.
            It’s partnerships we’ve built and stories we’ve helped grow.
          </p>
        </section>
