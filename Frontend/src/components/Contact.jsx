  ...
  return (
    <section className='flex flex-col md:flex-row justify-between items-start gap-16'>
      ...
      <div className='w-full md:w-1/2'>
        <div className='mb-12'>
          <h1 className='text-6xl font-serif text-black mb-2' style={{ fontFamily: 'Calisga, sans-serif' }}>Contact Us</h1>
          <p className='text-lg text-gray-600'>Don't be afraid to say</p>
          <p className='text-lg text-gray-600'>hello to us</p>
        </div>
