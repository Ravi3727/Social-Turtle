...
const AiVideosSection = () => {
    return (
        <div className='min-h-screen h-fit w-screen py-10'>
            <div className='flex flex-col w-screen  font-bold text-[56px] items-center justify-center  text-center'>
             ...
             <div className='perspective-distant perspective-origin-center'>
                 <img src="/images/carousel/image.png" className="shadow-lg object-cover bg-cover h-[70vh] w-full [clip-path:path('M0,0 H100 V80 Q50,120 0,80 Z')]" alt="" />
             </div>
        </div>
    )
}
