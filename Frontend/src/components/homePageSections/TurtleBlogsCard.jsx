...
const TurtleBlogsCard = () => {
  return (
    <div className='w-[438px] h-[530px] gap-4 flex flex-shrink-0 flex-col rounded-xl overflow-clip  shadow-[0_3px_0px_rgba(0,0,0,0.2)] border-1 border-[#D9D9D9]'>
        ...
        <div className='w-full flex justify-between items-center text-[18px] px-2  font-semibold'>
            <div>5 AI Tools That Are Changing the Digital Marketing Game in 2025</div>
