...
const TurtleBlogsCard = () => {
  return (
    <div style={{
                ...
                }} className='md:w-[438px] w-[323px] md:h-[530px] h-[472px] pb-4 gap-4 flex flex-shrink-0 flex-col rounded-xl overflow-clip  shadow-[0_3px_0px_rgba(0,0,0,0.2)] border-1 border-[#D9D9D9]'>
        ...
        <div className='w-[70%] text-[#434343] text-[14px] px-2 py-1'>
