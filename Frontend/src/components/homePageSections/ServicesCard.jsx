...
const ServicesCard = () => {
  return (
    <div className='border-[#000000] border-[0.2px] md:w-[352px] md:h-[233px] pt-3 w-[269px] h-[178px]  flex-shrink-0   rounded-lg px-4 pb-4' style={{ boxShadow: "0 8px 10px -5px rgba(0,0,0,0.3)" }}>
